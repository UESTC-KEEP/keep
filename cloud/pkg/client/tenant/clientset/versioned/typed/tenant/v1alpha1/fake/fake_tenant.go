...
var tenantsResource = schema.GroupVersionResource{Group: "keepedge.k8s.io", Version: "v1alpha1", Resource: "tenants"}

var tenantsKind = schema.GroupVersionKind{Group: "keepedge.k8s.io", Version: "v1alpha1", Kind: "Tenant"}

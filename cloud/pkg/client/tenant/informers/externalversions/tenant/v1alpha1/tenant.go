...
import (
	"context"
	tenantv1alpha1 "keep/cloud/pkg/apis/keepedge/tenant/v1alpha1"
	...
	v1alpha1 "keep/cloud/pkg/client/tenant/listers/tenant/v1alpha1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KeepedgeV1alpha1().Tenants(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KeepedgeV1alpha1().Tenants(namespace).Watch(context.TODO(), options)
			},
		},

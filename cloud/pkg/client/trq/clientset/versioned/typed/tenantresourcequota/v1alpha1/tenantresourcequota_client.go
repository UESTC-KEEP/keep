...
import (
	...
	"github.com/UESTC-KEEP/keep/cloud/pkg/client/trq/clientset/versioned/scheme"
...
func (c *KeepedgeV1alpha1Client) TenantResourceQuotas(namespace string) TenantResourceQuotaInterface {
	return newTenantResourceQuotas(c, namespace)
}

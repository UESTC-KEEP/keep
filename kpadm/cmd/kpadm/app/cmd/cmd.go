...
// NewKeepEdgeCommand  returns cobra.Command to run kpadm commands
func NewKeepEdgeCommand(in io.Reader, out, err io.Writer) *cobra.Command {
	cmds := &cobra.Command{
		Use:     "kpadm",
		Short:   "kpadm: Bootstrap keepedge cluster",

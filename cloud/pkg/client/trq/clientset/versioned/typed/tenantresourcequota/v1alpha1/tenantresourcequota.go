...
import (
	...
	scheme "github.com/UESTC-KEEP/keep/cloud/pkg/client/trq/clientset/versioned/scheme"
	"time"
...
type TenantResourceQuotasGetter interface {
	TenantResourceQuotas(namespace string) TenantResourceQuotaInterface
}
...
func newTenantResourceQuotas(c *KeepedgeV1alpha1Client, namespace string) *tenantResourceQuotas {

...
// DeviceModelSpec defines the model / template for a devices.It is a blueprint which describes the devices
// capabilities and access mechanism via property visitors.
type DeviceModelSpec struct {
	// Required: List of devices properties.
	Properties []DeviceProperty `json:"properties,omitempty"`
}

// DeviceProperty describes an individual devices property / attribute like temperature / humidity etc.
type DeviceProperty struct {
	// Required: The devices property name.
	Name string `json:"name,omitempty"`
	// The devices property description.
	// +optional
...
// The access mode for  a devices property.
type PropertyAccessMode string

// Access mode constants for a devices property.
const (
...
// DeviceModel is the Schema for the devices model API

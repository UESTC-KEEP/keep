...
type SharedInformerFactory interface {
	...
	Keepedge() tenantresourcequota.Interface
}

func (f *sharedInformerFactory) Keepedge() tenantresourcequota.Interface {
	return tenantresourcequota.New(f, f.namespace, f.tweakListOptions)
}

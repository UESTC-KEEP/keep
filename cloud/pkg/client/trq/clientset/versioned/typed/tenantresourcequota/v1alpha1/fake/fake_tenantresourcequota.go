...
var tenantresourcequotasResource = schema.GroupVersionResource{Group: "keepedge.k8s.io", Version: "v1alpha1", Resource: "tenantresourcequotas"}

var tenantresourcequotasKind = schema.GroupVersionKind{Group: "keepedge.k8s.io", Version: "v1alpha1", Kind: "TenantResourceQuota"}
...
func (c *FakeTenantResourceQuotas) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TenantResourceQuota, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(tenantresourcequotasResource, c.ns, name), &v1alpha1.TenantResourceQuota{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.TenantResourceQuota), err
}

// List takes label and field selectors, and returns the list of TenantResourceQuotas that match those selectors.
func (c *FakeTenantResourceQuotas) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TenantResourceQuotaList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(tenantresourcequotasResource, tenantresourcequotasKind, c.ns, opts), &v1alpha1.TenantResourceQuotaList{})
	...
	list := &v1alpha1.TenantResourceQuotaList{ListMeta: obj.(*v1alpha1.TenantResourceQuotaList).ListMeta}
	for _, item := range obj.(*v1alpha1.TenantResourceQuotaList).Items {
...
func (c *FakeTenantResourceQuotas) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(tenantresourcequotasResource, c.ns, opts))
...
func (c *FakeTenantResourceQuotas) Create(ctx context.Context, tenantResourceQuota *v1alpha1.TenantResourceQuota, opts v1.CreateOptions) (result *v1alpha1.TenantResourceQuota, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(tenantresourcequotasResource, c.ns, tenantResourceQuota), &v1alpha1.TenantResourceQuota{})
...
func (c *FakeTenantResourceQuotas) Update(ctx context.Context, tenantResourceQuota *v1alpha1.TenantResourceQuota, opts v1.UpdateOptions) (result *v1alpha1.TenantResourceQuota, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(tenantresourcequotasResource, c.ns, tenantResourceQuota), &v1alpha1.TenantResourceQuota{})
...
func (c *FakeTenantResourceQuotas) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(tenantresourcequotasResource, c.ns, name), &v1alpha1.TenantResourceQuota{})
...
func (c *FakeTenantResourceQuotas) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(tenantresourcequotasResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.TenantResourceQuotaList{})
	return err
}
...
func (c *FakeTenantResourceQuotas) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TenantResourceQuota, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(tenantresourcequotasResource, c.ns, name, pt, data, subresources...), &v1alpha1.TenantResourceQuota{})
